...
public class WandCap {
	...
	public WandCap (String tag, float discount, ItemStack item, int craftCost, ResourceLocation texture) {
		this.setTag(tag);
	...
	public WandCap (String tag, float discount, List<Aspect> specialAspects, float discountSpecial, ItemStack item, int craftCost, ResourceLocation texture) {
		this.setTag(tag);
		this.baseCostModifier = discount;
