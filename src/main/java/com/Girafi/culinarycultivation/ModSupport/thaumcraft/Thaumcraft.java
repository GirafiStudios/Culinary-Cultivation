    ...
    public void init() {
        ...
        for (int j = 0; j < iJar; ++j) {
            ...
            if (meta == StorageJarType.WATER.getMetaData()) {
                ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.storageJar, 1, StorageJarType.WATER.getMetaData()), new AspectList().add(Aspect.CRYSTAL, 1).add(Aspect.WATER, 1));
            } else if (meta == StorageJarType.MILK.getMetaData()) {
                ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.storageJar, 1, StorageJarType.MILK.getMetaData()), new AspectList().add(Aspect.CRYSTAL, 1).add(Aspect.HUNGER, 1).add(Aspect.WATER, 1));
            } else {
