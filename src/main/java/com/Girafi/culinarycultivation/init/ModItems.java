...
public class ModItems {
    ...
    public static final Item storageJar = new ItemStorageJar().setUnlocalizedName("storageJar").setTextureName("storageJar");
    public static final Item toolHandle = new SourceItem().setUnlocalizedName("toolHandle").setTextureName("toolHandle");
    //public static final Item rennet_bucket = new ItemBucket(ModBlocks.cheese).setUnlocalizedName(Reference.MOD_ID.toLowerCase() + ":" + "bucketRennet").setTextureName(Reference.MOD_ID.toLowerCase() + ":" + "bucketRennet");
