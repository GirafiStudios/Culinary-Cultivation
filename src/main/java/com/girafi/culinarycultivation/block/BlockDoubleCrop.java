...
public class BlockDoubleCrop extends BlockBush implements IGrowable { //TODO Fix a couple of thing, after extending BlockCrop
    ...
    private void rightClickHarvest(World world, BlockPos pos, IBlockState state) {
        int age = state.getValue(AGE);
        if (age == 7) {
