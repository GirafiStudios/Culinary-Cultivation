...
public class Events {
    public static void init() { //TODO Change how MobDropEvent is done. Make constructor that makes new instance of MobDropEvent, so this Event class is not needed anymore
