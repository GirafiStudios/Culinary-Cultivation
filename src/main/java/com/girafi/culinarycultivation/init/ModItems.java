...
public class ModItems {
    ...
    public static final Item GENERAL = new ItemGeneral();
    ...
    public static void setup() {
        ...
        MobDropEvent.register(EntityCow.class, true, new ItemStack(ModItems.GENERAL, 1, ItemGeneral.Type.CALF_BELLY.getMetadata()), ItemStack.EMPTY, false, ModItems.MEAT_CLEAVER, -1, 0, 1);
