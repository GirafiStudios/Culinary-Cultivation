...
public class ItemKitchenKnife extends ItemTool implements ICraftingTool {
    ...
    @Override
    public boolean onBlockDestroyed(@Nonnull ItemStack stack, @Nullable World world, @Nullable IBlockState state, @Nullable BlockPos pos, @Nullable EntityLivingBase entityLiving) {
